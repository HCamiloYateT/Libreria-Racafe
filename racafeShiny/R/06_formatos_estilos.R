...
# ---- Registro de formatos: racafeShiny delega en racafeCore ----
# DefinirFormato, ObtenerFormato y ListarFormatos viven en racafeCore.
# racafeShiny los re-exporta para que el usuario no necesite cargar
# racafeCore explicitamente cuando solo usa racafeShiny.

#' @rdname DefinirFormato
#' @export
...
#' @rdname ListarFormatos
#' @export
ListarFormatos <- racafeCore::ListarFormatos
...
#' @rdname FormatearNumero
#' @export
FormatearNumero <- racafeCore::FormatearNumero
